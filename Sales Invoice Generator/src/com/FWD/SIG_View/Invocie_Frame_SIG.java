...
import com.FWD.SIG_Controller.Invoice_Table_SelectLis;
 ...
 * @author Abdu Sayed
 */
public class Invocie_Frame_SIG extends javax.swing.JFrame {

    /**
     * Creates new form InvFrame_SIG
     */
    public Invocie_Frame_SIG() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Invocie_Frame_SIG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Invocie_Frame_SIG().setVisible(true);
            }
        });
    }
    ...
    private ArrayList<Invoice_Header> invHdr ;
    private ArrayList<Invoice_Line> invLine ;
    Model_Of_Invoice_Item invitemmodel ;
    InvHdrTbModel invhdrmodel ;
    public static SimpleDateFormat sDateFormat = new SimpleDateFormat("dd-MM-yyyy");
    private Invoice_Table_SelectLis SCListener = new Invoice_Table_SelectLis(this);
    
    
    public Invoice_Header matchedID(int id)
    {
        for(Invoice_Header invd : invHdr)
        {
            if(invd.get_Invoice_Number() == id)
            {
                return invd;
            }
        }
    ...
    public void setInvLine(ArrayList<Invoice_Line> invLine) {
        this.invLine = invLine;
    }

    public Model_Of_Invoice_Item getInvitemmodel() {
        return invitemmodel;
    }

    public void setInvitemmodel(Model_Of_Invoice_Item invitemmodel) {
    ...
    public void setInvHdr(ArrayList<Invoice_Header> invHdr) {
        this.invHdr = invHdr;
    }

    public ArrayList<Invoice_Header> getInvHdr() {
       return invHdr;
    }
